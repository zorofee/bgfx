...
public:
  ...
  void setObjectName(VkDevice object, const std::string& name);
...
#define CLASS_NAME bgfx::upToLastSpace(typeid(*this).name())
#define NAME_FILE_LOCATION  std::string(" in ") + std::string(bgfx::fileNameSplitter(__FILE__)) + std::string(":" S__LINE__ ")")
...
#define LABEL_SCOPE_VK(_cmd)                                                                                                                \
  auto _scopeLabel =  m_debug.scopeLabel(_cmd, std::string(CLASS_NAME) + std::string("::") + std::string(__func__) + std::string(", in ")   \
                                   + std::string(bgfx::fileNameSplitter(__FILE__)) + std::string(":" S__LINE__ ")"))
