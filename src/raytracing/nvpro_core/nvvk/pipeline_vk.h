...
public:
...

  {
    ...
    BGFX_VKAPI(vkCreateShaderModule)(device, &createInfo, nullptr, &shaderModule);
  ...
  VkPipeline createPipeline(const VkPipelineCache& cache)
  {
    update();
    VkPipeline pipeline;
    BGFX_VKAPI(vkCreateGraphicsPipelines)(device, cache, 1, (VkGraphicsPipelineCreateInfo*)&createInfo, nullptr, &pipeline);
    return pipeline;
  }
  ...
  void destroyShaderModules()
  {
    ...
    {
      BGFX_VKAPI(vkDestroyShaderModule)(device, shaderModule, nullptr);
    }
