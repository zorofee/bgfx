...
inline VkDeviceAddress getBufferDeviceAddressKHR(VkDevice device, VkBuffer buffer)
{
  ...
  info.buffer                    = buffer;
  return BGFX_VKAPI(vkGetBufferDeviceAddressKHR)(device, &info);
}
...
inline VkDeviceAddress getBufferDeviceAddress(VkDevice device, VkBuffer buffer)
{
  ...
  info.buffer                    = buffer;
  return BGFX_VKAPI(vkGetBufferDeviceAddress)(device, &info);
}
...
{
  VkBuffer buffer;
  VkResult result = BGFX_VKAPI(vkCreateBuffer)(device, &info, nullptr, &buffer);
